...
public class CONSTANTES {
    public static final String RUTA_DATA = "src/ec/edu/espol/resources/data.txt";
    public static final String RUTA_SHORT_DATA = "src/ec/edu/espol/resources/shortdata.txt";
